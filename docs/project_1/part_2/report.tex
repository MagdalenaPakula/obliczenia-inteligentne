...
Czwarty eksperyment skupia się na obserwacji procesu nauki sieci MLP. Dzięki wykorzystaniu metody partial-fit 
można śledzić zmiany skuteczności modelu na zbiorze treningowym i testowym po kolejnych epokach nauki. 
Dodatkowo, badając wpływ różnych inicjalizacji wag neuronów na finalne rezultaty klasyfikacji, można lepiej 
