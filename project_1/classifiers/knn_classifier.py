...
def knn_experiment(X, dataset_name):
    ...
    for dataset_name, knn, X, y in [("Minimalny klasyfikator KNN - Zbiór treningowy", knn_min, X_train, y_train),
        ...
        plt.title(f"Macierz pomyłek dla {dataset_name}")
